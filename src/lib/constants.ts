...
export const SERVICES = [
  ...
  },
  {
    ...
    slug: "adiestramiento",
    icon: "🎓",
    tagline: "Conexión y aprendizaje positivo.",
    description:
      "Mejora la comunicación con tu mejor amigo. Clases de obediencia básica, corrección de conductas, todo mediante refuerzo positivo.",
    features: [
      "Obediencia básica y avanzada",
      "Modificación de conducta",
      "Servicio a domicilio o internado",
      "Sesiones individuales con perros mentor",
    ],
